...
object InsertTest extends App {
  ...
  private val response2: IndexResponse = ElasticQueryBuilder.insert(PERSON_INDEX, PERSON_TYPE, person2)
  ...
  private val response3: IndexResponse = ElasticQueryBuilder.insert(PERSON_INDEX, PERSON_TYPE, json)
